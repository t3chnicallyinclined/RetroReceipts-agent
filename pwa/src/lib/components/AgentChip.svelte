<script lang="ts">
	...
	// ⬢ Desktop-agent chip — pure render of the running tray/Tauri agent's build. The agent-status lifecycle is
	// owned centrally by AppLive in +layout. Links to Settings, where the full "Desktop companion" card lives.
